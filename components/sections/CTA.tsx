    ...
    <section id="contact" className="relative overflow-hidden py-[88px] md:py-[116px]">
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          sizes="100vw"
          className="object-cover object-[center_55%] brightness-[1.05] contrast-[0.95]"
        />
        <div className="absolute inset-0 bg-[rgba(8,28,46,0.85)]" />
      </div>

      <div className="relative z-[2] mx-auto max-w-[620px] px-5 text-center md:px-10">
        <RevealOnScroll>
          <h2 className="mb-2 font-display text-[clamp(2.1rem,5vw,3.8rem)] font-semibold leading-[1.07] text-white">
            <Multiline text={t("title")} />
          </h2>
          <span className="mb-[26px] block font-display text-[clamp(1.1rem,2.8vw,2.1rem)] italic text-sable/78">
            {t("subtitle")}
          </span>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {contacts.map((contact) => (
              <a
                ...
                className="flex items-center gap-3 rounded-lg border border-sable/20 bg-white/[0.08] px-6 py-[17px] transition-all hover:-translate-y-0.5 hover:border-sable hover:bg-sable/13"
              >
